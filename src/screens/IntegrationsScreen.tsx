  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>
        Connect your family tools. We import work events as "Title - Busy" and never write back without consent.
      </Text>
      <ProviderCard
        provider="google"
        status="connected"
        ...
        onDisconnect={() => Alert.alert('Disconnected', 'Google Calendar removed')}
      />
      <ProviderCard
        provider="outlook"
        status="connected"
      ...
      <ProviderCard
        ...
        onConnect={() => Alert.alert('Connect', 'CalDAV connection flow coming soon.')}
